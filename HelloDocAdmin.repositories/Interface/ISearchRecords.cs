...
namespace HelloDocAdmin.Repositories.Interface
{
    public interface ISearchRecords
    {
        ...
        public Task<RequestRecords> GetRequestsbyfilterForRecords(short status, string patientname, int requesttype, DateTime startdate, DateTime enddate, string physicianname, string email, string phonenumber, int currentpage = 1, int pagesize = 10);
        ...
        public Task<EmailRecords> EmailLogs(int accounttype, string email, string ReciverName, DateTime CreatedDate, DateTime SendDate, int pagesize = 10, int currentpage = 1);
